...
{
    [PluginInfo(Name = "ReadBackDynamic", Category = "DX11.Buffer", Version = "Raw", Author = "vux", AutoEvaluate = false)]
    public class ReadBackDynamicRawBuffer : IPluginEvaluate, IDX11ResourceDataRetriever, IPartImportsSatisfiedNotification
    {
        [Config("Layout")]
        ...
        [Input("Input")]
        protected Pin<DX11Resource<DX11DynamicRawBuffer>> FInput;
        ...
        public void Evaluate(int SpreadMax)
        {
            if (this.FInput.PluginIO.IsConnected)
            {
                ...
                DX11DynamicRawBuffer b = this.FInput[0][this.AssignedContext];
