...
{
    [PluginInfo(Name = "ImmutableBuffer", Category = "DX11.Buffer", Version = "Raw", Author = "vux")]
    public class ImmutableRawBuffer : IPluginEvaluate, IDX11ResourceHost, IDisposable
    {
