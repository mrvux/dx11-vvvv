...
{
    [PluginInfo(Name = "Renderer", Category = "DX11",Version="Texture1d", Author = "vux")]
    public class DX11Texture1dRendererNode : IDX11RendererProvider, IPluginEvaluate, IDisposable, IDX11Queryable
    {
        ...
        protected ISpread<DX11Resource<DX11WriteableTexture1d>> FOutTexture;
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            {
                this.FOutTexture[0] = new DX11Resource<DX11WriteableTexture1d>();
            }
        ...
        public void Render(DX11RenderContext context)
        {
            ...
            if (this.FInEnabled[0])
            {
                ...
                DX11WriteableTexture1d target = this.FOutTexture[0][context];
