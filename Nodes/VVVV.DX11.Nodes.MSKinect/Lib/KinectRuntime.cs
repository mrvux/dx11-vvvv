...
namespace VVVV.MSKinect.Lib
{
    public class KinectRuntime
    {
        ...
        public static readonly int[] SKELETON_INDICES = new int[]
        {
            (int)JointType.HipCenter , (int)JointType.Spine,
            (int)JointType.Spine , (int)JointType.ShoulderCenter,
            (int)JointType.ShoulderCenter , (int)JointType.Head,
            (int)JointType.ShoulderCenter , (int)JointType.ShoulderLeft,
            (int)JointType.ShoulderLeft , (int)JointType.ElbowLeft,
            (int)JointType.ElbowLeft , (int)JointType.WristLeft,
            (int)JointType.WristLeft , (int)JointType.HandLeft,
            (int)JointType.ShoulderCenter , (int)JointType.ShoulderRight,
            (int)JointType.ShoulderRight , (int)JointType.ElbowRight,
            (int)JointType.ElbowRight , (int)JointType.WristRight,
            (int)JointType.WristRight , (int)JointType.HandRight,

            (int)JointType.HipCenter , (int)JointType.HipLeft,
            (int)JointType.HipLeft , (int)JointType.KneeLeft,
            (int)JointType.KneeLeft , (int)JointType.AnkleLeft,
            (int)JointType.AnkleLeft , (int)JointType.FootLeft,

            (int)JointType.HipCenter , (int)JointType.HipRight,
            (int)JointType.HipRight , (int)JointType.KneeRight,
            (int)JointType.KneeRight , (int)JointType.AnkleRight,
            (int)JointType.AnkleRight , (int)JointType.FootRight,
        };

        public static readonly int[] SKELETON_ARMS = new int[]
        {
            (int)JointType.ShoulderLeft , (int)JointType.ElbowLeft,
            (int)JointType.ElbowLeft , (int)JointType.WristLeft,
            (int)JointType.WristLeft , (int)JointType.HandLeft,
        ...
        public static readonly int[] SKELETON_UPBODY = new int[]
        {
            (int)JointType.ShoulderCenter , (int)JointType.Head,
            (int)JointType.ShoulderCenter , (int)JointType.ShoulderLeft,
            (int)JointType.ShoulderCenter , (int)JointType.ShoulderRight,
        ...
        public static readonly int[] SKELETON_LEGS = new int[]
        {
            (int)JointType.HipCenter , (int)JointType.HipLeft,
            (int)JointType.HipLeft , (int)JointType.KneeLeft,
            (int)JointType.KneeLeft , (int)JointType.AnkleLeft,
        ...
        public static readonly int[] SKELETON_CHEST = new int[]
        {
            (int)JointType.HipLeft,(int)JointType.HipRight,
            (int)JointType.ShoulderLeft,(int)JointType.ShoulderRight,
        ...
        public void SetColor(bool enable, bool infrared)
        {
            ColorImageFormat cf = infrared ? ColorImageFormat.InfraredResolution640x480Fps30 : ColorImageFormat.RgbResolution640x480Fps30;

            if (enable)
            {
                this.Runtime.ColorStream.Enable(cf);
