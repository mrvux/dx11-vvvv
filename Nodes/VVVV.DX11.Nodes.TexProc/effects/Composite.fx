...
float4 pNORMAL(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    ...
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pSUBTRACT(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
    float4 c = bld(c0-c1, c0, c1);
...
float4 pSCREEN(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pDARKEN(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pLIGHTEN(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pDIFFERENCE(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pEXCLUSION(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pOVERLAY(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pHARDLIGHT(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pSOFTLIGHT(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pDODGE(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pBURN(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pREFLECT(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pFREEZE(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pHEAT(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
...
float4 pDIVIDE(float4 PosWVP : SV_POSITION, float2 x : TEXCOORD0) : SV_TARGET
{
    float4 c0 = tex0.Sample(s0, x);
    float4 c1 = tex1.Sample(s0, x) * float4(1, 1, 1, Opacity);
    float4 c = bld(c0/c1, c0, c1);
